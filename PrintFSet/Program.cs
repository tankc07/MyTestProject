	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			if (args == null || args.Length == 0)
			{
				...
				if (orderType == "sf")
				{
					args = new string[] { @"E:\WorkSpace\Source\Work_Project\面单打印模板\frx\Logic_Shunfeng.frx" };
				}
				else if (orderType == "yz")
				{
					args = new string[] { @"E:\WorkSpace\Source\Work_Project\面单打印模板\frx\Logic_EmsYouzheng.frx" };
				}
				else if (orderType == "jd")
				{
					args = new string[] { @"E:\WorkSpace\Source\Work_Project\面单打印模板\frx\Logic_JingdongWl.frx" };
					
				}
				else if (orderType == "st")
				{
					args = new string[] { @"E:\WorkSpace\Source\Work_Project\面单打印模板\frx\Logic_ShenTong.frx" };

				}
				else if (orderType == "nyz")
				{
					args = new string[] { @"E:\WorkSpace\Source\Work_Project\面单打印模板\frx\Logic_NewEms.frx" };
				}
				...
				{
					args = new string[] { @"E:\WorkSpace\Source\Work_Project\面单打印模板\frx\shtx_hd.frx" };
				}
				else
				{
					Console.WriteLine(@"打印方案不存在");
